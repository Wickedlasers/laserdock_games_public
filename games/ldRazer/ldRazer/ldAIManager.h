...
namespace ldRazer
{
    ...
    struct agent
    {
        ...
        agent(uint16_t bodyId, ldBody *bodyPtr, targetFnc tgtFnc, SteeringType steer) : bodyId(bodyId),
                                                                                        bodyPtr(bodyPtr),
                                                                                        getTarget(tgtFnc),
                                                                                        steering(steer)
        {
        ...
        agent(uint16_t bodyId, ldBody *bodyPtr, NavMesh *mesh, float scale) : bodyId(bodyId), bodyPtr(bodyPtr),
