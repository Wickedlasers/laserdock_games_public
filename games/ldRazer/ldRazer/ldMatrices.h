...
namespace ldRazer
{
    ...
    template<typename T> using ldVec3 = ldVector<T, 3>;
    template<typename T> using ldVec4 = ldVector<T, 4>;
    ...
    template<typename T>
    ldMat2<T> makeScale2(const ldVec2<T> &S)
    {
        return makeScale2(S.x, S.y);
    }

    template<typename T>
    ldVec2<T> operator*(const ldMat2<T> &M, const ldVec2<T> &v)
    {
        return ldVec2<T>{
                M(0, 0) * v[0] + M(0, 1) * v[1],
                M(1, 0) * v[0] + M(1, 1) * v[1]
...
// A transposed matrix matrix transform
    ...
    template<typename T>
    ldMat3<T> makeScale3(const ldVec2<T> &S)
    {
    ...
    template<typename T>
    ldMat3<T> makeTranslation3(const ldVec2<T> &P)
    {
        return makeTranslation3(P.x, P.y);
    }

    template<typename T>
    ldVec2<T> operator*(const ldMat3<T> &M, const ldVec2<T> &v)
    {
        return ldVec2<T>{
                M(0, 0) * v[0] + M(0, 1) * v[1],
                M(1, 0) * v[0] + M(1, 1) * v[1]
    ...
    template<typename T>
    ldVec2<T> transform(const ldMat3<T> &M, const ldVec2<T> &v)
    {
        return ldVec2<T>{
    ...
    template<typename T>
    ldVec3<T> operator*(const ldMat3<T> &M, const ldVec3<T> &v)
    {
        return ldVec3<T>{
